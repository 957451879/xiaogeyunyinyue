 ...
 * @method 获取热门歌手
 */
export const getHotSinger = limit => api.get(`/top/artists?offset=0&limit=${limit}`, {})
 ...
 * @params id 歌手 id
 */
export const getArtistMv = params => api.get(`/artist/mv?id=${params}`, {  })
 ...
 * @method 获取歌单详情
 */
 export const getPlayListDetail2 = (id) =>
 ...
 * @method 获取评论
 */
export const getComment = (type,params) => api.get(`/comment/${type}`,{params})